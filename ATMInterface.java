...
class BankAccount {
	...
	BankAccount(String cName, String cld){
		customerName = cName;
		customerld = cld;
	}
	...
	public void transfer(double amount, BankAccount acc) {
		if(this.balance < amount) {
			clrscr();
			System.out.println("==============================");
			System.out.println("Transfer Fails due to insufficent balance!!");
			System.out.println("==============================");
	...
	private void showMenu() {
		...
		System.out.println("Welcome "+customerName);
		String customerld = null;
		System.out.println("Your ID is "+customerld);
		do {
			System.out.println("\n");
			System.out.println("\n");
